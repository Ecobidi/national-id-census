...
app.get('/by-state', (req, res) => {
  res.render('state-analysis')
})

app.get('/by-region', (req, res) => {
  res.render('regional-analysis')
})

app.get('/state-analysis-data', ReportController.getStatesReport)

app.get('/regional-analysis-data', ReportController.getRegionalReport)
