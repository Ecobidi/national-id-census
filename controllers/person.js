  ...
  static async createPerson(req, res) {
    ...
    try {
      if (req.file) {
        ...
        const imageInfo = await streamUpload(editedImage, process.env.PROJECT_CLOUDINARY_IMAGE_FOLDER + "/persons")
      ...
      //   await PersonService.create(dao)
      // }
      req.flash('success_msg', 'Person Data Successfully Created')
      res.redirect('/persons')
    } catch (err) {
      console.log(err)
      res.redirect('/persons')
